      ...
      <header className="sticky top-0 z-50 w-full border-b border-primary/20 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              className="px-4 py-2 rounded-lg text-sm font-bold border border-primary/30 text-primary hover:bg-primary/10 transition-all"
              href="/entrar"
            >
              Entrar
            </Link>
            <Link
              className="hidden sm:inline-flex px-4 py-2 rounded-lg text-sm font-bold border border-slate-300 dark:border-primary/20 hover:border-primary/50 hover:text-primary transition-all"
              href="/cadastrar"
            >
              Cadastrar
            </Link>
